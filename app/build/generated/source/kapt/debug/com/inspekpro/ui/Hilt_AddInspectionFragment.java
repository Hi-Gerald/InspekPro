...
public abstract class Hilt_AddInspectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddInspectionFragment() {
    super();
  }

  Hilt_AddInspectionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddInspectionFragment_GeneratedInjector) this.generatedComponent()).injectAddInspectionFragment(UnsafeCasts.<AddInspectionFragment>unsafeCast(this));
    }
  }
