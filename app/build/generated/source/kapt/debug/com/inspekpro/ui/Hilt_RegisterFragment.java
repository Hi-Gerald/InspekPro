...
public abstract class Hilt_RegisterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RegisterFragment() {
    super();
  }

  Hilt_RegisterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RegisterFragment_GeneratedInjector) this.generatedComponent()).injectRegisterFragment(UnsafeCasts.<RegisterFragment>unsafeCast(this));
    }
  }
